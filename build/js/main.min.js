...
/* harmony import */ var _modal_init_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal/init-modal */ "./js/modal/init-modal.js");

var aboutCompanyButton = document.querySelector('.about-company__button');
var aboutCompanyDescription = document.querySelector('.about-company__wrapper');
...
var navigationTab = document.querySelector('.navigation__wrapper').querySelector('h2');
...
var footerContactsTab = document.querySelector('.footer-contacts__wrapper').querySelector('h2');
var catalogTitle = document.querySelector('.catalog__wrapper').querySelector('h2');
var catalogTitleInitial = document.querySelector('.catalog__wrapper').querySelector('h2').textContent;
var headerButton = document.querySelector('.inner-header__button');
var headerButtonInitial = document.querySelector('.inner-header__button').textContent;
var mobileVersion = window.matchMedia('(max-width: 767px)');
var tabletVersion = window.matchMedia('(max-width: 1023px)');
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    Object(_modal_init_modal__WEBPACK_IMPORTED_MODULE_0__["initModals"])();
    showImgs();
  });
});

function showImgs() {
  document.querySelectorAll('.card__img').forEach(function (element) {
    return showImg(element);
  });
}
...
function openOneTab(element) {
  if (element.classList.contains('is-closed')) {
    footerAccordion.forEach(function (accordionElement) {
      return closeTabAccordeon(accordionElement);
    });
...
navigationTab.addEventListener('click', function () {
  openOneTab(navigation);
});
contactsToggle.addEventListener('click', function () {
  openOneTab(footerContacts);
});
footerContactsTab.addEventListener('click', function () {
  openOneTab(footerContacts);
});

/***/ }),

/***/ "./js/modal/init-modal.js":
/*!********************************!*\
  !*** ./js/modal/init-modal.js ***!
  \********************************/
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal */ "./js/modal/modal.js");
...
var initModals = function initModals() {
  ...
  modals = new _modal__WEBPACK_IMPORTED_MODULE_0__["Modals"](settings);
};
...
/*!*************************!*\
  !*** ./js/utils/ios.js ***!
  \*************************/
/*! exports provided: iosChecker, iosVhFix */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _ios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ios */ "./js/utils/ios.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ScrollLock = /*#__PURE__*/function () {
  function ScrollLock() {
    ...
    this._iosChecker = _ios__WEBPACK_IMPORTED_MODULE_0__["iosChecker"];
  ...
  _createClass(ScrollLock, [{
    ...
    value: function disableScrolling() {
      ...
      if (this._getScrollbarWidth()) {
        ...
        header.style.marginRight = "".concat(this._getScrollbarWidth(), "px");
