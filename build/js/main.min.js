...
var headerButton = document.querySelector('.inner-header__button').querySelector('span');
var headerButtonInitial = document.querySelector('.inner-header__button').querySelector('span').textContent;
